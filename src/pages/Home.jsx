...
focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-[#141319]"
        ...
        <div className="right w-1/2 h-[80vh] bg-[#141319] mt-5 p-5 rounded-lg">
          <div className="skeleton w-full h-full flex items-center flex-col justify-center">
            <div className="circle flex items-center justify-center text-[35px] p-[20px] w-[70px] h-[70px] rounded-[50%]  bg-gradient-to-tr from-[#545c93] to-[#b84c7b]"><HiOutlineCode/></div>
            <p className="text-gray-400 mt-4">Your generated component will appear here</p>
          </div>
        </div>
      </div>
    </div>
